...
class BaseModel:
    ...
    def _asdict(self, include_hybrid_properties=False) -> Dict[str, Any]: ...

    def to_dict(self, include_hybrid_properties=False) -> Dict[str, Any]: ...

    def dict(self, include_hybrid_properties=False) -> Dict[str, Any]: ...
